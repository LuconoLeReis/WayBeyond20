class DigitalDice {
     ...
     * back into WayBeyond20 dice objects.
     *
    ...
    parseMessageBrokerRoll(brokerData, passive=false) {
        try {
            ...
            // Fill WayBeyond20 dice objects in insertion order (this._dice already preserves original roll order)
    ...
    /**
     * Parse a new D&D Beyond Game Log entry and map its dice results back into WayBeyond20 dice objects.
     * 
    ...
    async handleCompletedRoll() {
        ...
        // Keep this method to finalize totals/modifiers for WayBeyond20 roll objects.
    }
}
